...
| ------- | ------- | ------- | 
| **2026.04 - 2026.09** | **MSA Fullstack 양성과정** | **Spring, React, Infra** |
| **2025.11 - 2026.02** | **클라우드 인프라 전문가 양성과정** | **Docker K8s와 CI/CD, Terraform, ArgoCD 기반 인프라 학습** |
| **2025.02** | **국민대학교 소프트웨어전공 졸업** | |
| **2024.09 - 2024.12** | **㈜엔투솔루션 백엔드 인턴** | **Springboot, jsp, Mybatis 등 활용한 백엔드 개발** |
...
| **2024.10 - 2024.11** | **🔗[환경공단 프로젝트](https://www.re.or.kr/info/listRecyclableResourcesPageNew.do)** | **(주)엔투솔루션 인턴으로 폐기물 처리·통계 페이지 개발** |
